...
function updateBarChart( group, colorChosen ) {
    ...
    plot.selectAll( "text.yAxis" ) // target the text element(s) which has a yAxis class defined
            ...
            .duration( 750 )
            .attr( "text-anchor", "middle" )
            .attr( "x", function( d, i ) { return ( i * ( width / currentDatasetBarChart.length ) ) + ( ( width / currentDatasetBarChart.length - barPadding ) / 2 ); })
            .attr( "y", function( d ) { return yScale( d.measure ) + 14; })
            .text( function( d ) { return formatAsInteger( d3.round( d.measure ) ); })
            .attr( "class", "yAxis" );
...
function dsLineChart() {
    ...
    plot.selectAll( ".dot" )
            ...
            .attr( "fill", 
                    function( d ) { return d.measure === d3.min( firstDatasetLineChart, 
                    function( d ) { return d.measure; }) ? "red" : ( d.measure === d3.max( firstDatasetLineChart, 
...
function updateLineChart( group, colorChosen ) {
    ...
    var path = plot
            ...
            .attr( "class", "dot" )
            .attr( "fill", 
                    function( d ) { return d.measure === d3.min( currentDatasetLineChart, 
