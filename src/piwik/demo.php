...
//Edit
define('SITE_URL', 'http://analytics.veorg.cisco.com');
define('SITE_ID', 1);
define('TOKEN', 'anonymous');
...
if ($piwik->hasError()) {
	...
	$piwik->setRange(date('Y-m-d', mktime(0, 0, 0, 12, 24, 2013)), date('Y-m-d', mktime(0, 0, 0, 12, 31, 2013)));
	...
	<h2>Summary <?php echo date('Y-m-d', mktime(0, 0, 0, 12, 24, 2013)); ?> - <?php echo date('Y-m-d', mktime(0, 0, 0, 12, 31, 2013)); ?></h2>
	<ul>
