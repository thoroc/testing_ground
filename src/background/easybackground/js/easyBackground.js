( function( e ) {
    ...
    e.fn.easyBackgroundParticles = function( t ) {
        ...
        var l = function() {
            for( var e = 0; e < n.numParticles; e++ ) {
                ...
                o[e] = {scale: a( n.minScale, n.maxScale ), x: a( 0, s.width ), y: a( 0, s.height ), rotation: 0, xpeed: a( n.minSpeedX, n.maxSpeedX ), yspeed: a( n.minSpeedY, n.maxSpeedY ), rotationSpeed: a( n.minRotateSpeed, n.maxRotateSpeed ), color: "rgba(" + t + "," + u + ")", opacity: u, borderColor: "rgb(" + r + ")"}
            }
            h()
        };
        var c = function( e ) {
    ...
    e.fn.easyBackground = function( t ) {
            ...
            if( t.substr( 0, 7 ) == "youtube" ) {
                ...
                if( s ) {
                    ...
                    window.onYouTubeIframeAPIReady = function() {
                        var e = new YT.Player( "easy-background-player", {width: 1, height: 1, videoId: s, playerVars: {controls: 0, showinfo: 0, modestbranding: 1, iv_load_policy: 3, wmode: "transparent"}, events: {onReady: function( e ) {
                                    u();
                                    if( n.mute ) {
                                        e.target.mute()
                                    }
                    ...
                    var u = function() {
                        ...
                        if( t / n.ratio < r ) {
                            ...
                            e( "#easy-background-player" ).css( {left: ( t - s ) / 2, top: 0} )
                        } else {
                            var o = Math.ceil( t / n.ratio );
                            e( "#easy-background-player" ).width( t );
                            e( "#easy-background-player" ).height( o );
                            e( "#easy-background-player" ).css( {left: 0, top: ( r - o ) / 2} )
                        }
                    };
        ...
        function l( t, r ) {
            var i = {colorAR: t[0][0], colorAG: t[0][1], colorAB: t[0][2], colorBR: t[1][0], colorBG: t[1][1], colorBB: t[1][2]};
            var s = {colorAR: r[0][0], colorAG: r[0][1], colorAB: r[0][2], colorBR: r[1][0], colorBG: r[1][1], colorBB: r[1][2]};
            e( i ).animate( s, {duration: n.duration, easing: n.gradientEase, step: function() {
        ...
        function h( t, r ) {
            ...
            e( s ).animate( o, {duration: n.duration, easing: "linear", step: function() {
        ...
        if( n.wrapNeighbours ) {
            ...
            i.siblings( ":not(script)" ).each( function( t, n ) {
                ...
                if( n.css( "position" ) == "static" ) {
                    n.css( {position: "relative", "z-index": "2"} )
                }
            } )
        }
        if( !r ) {
