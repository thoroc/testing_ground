...
namespace TankDataConverter
{
    static class BxmlReader
    {
        ...
        /// <remarks>
        ///     The WoT data files do not have a consistent type for all the numbers. Expect to see raw numbers (like <c>5.7</c>)
        ///     mixed freely with string numbers (like <c>"5.7"</c>).</remarks>
        ...
        /// <summary>
        ///     Reads a value of type dictionary from the current position of the binary reader. Note that in addition to a number
        ///     of children, a dictionary may also have an "own" value, which is never a dictionary, and which this function
        ///     stores at the empty string key (<c>result[""]</c>).</summary>
        /// <param name="reader">
        ...
        /// <summary>
        ///     Reads a value from the current position of the binary reader. The value may be a nested dictionary, or one of the
